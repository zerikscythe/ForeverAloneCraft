...
VALUES
    ...
    ('ironforge_bank',     1537, 0,   'bank',          'Ironforge Bank',          -4886.6,  -997.6, 504.0),
    ('ironforge_mailbox',  1537, 0,   'mailbox',       'Ironforge Mailbox',       -4910.4,  -976.2, 501.4),
    ('ironforge_ah',       1537, 0,   'auction_house', 'Ironforge Auction House', -4948.0,  -901.5, 505.2),
    ('ironforge_inn',      1537, 0,   'inn',           'Ironforge Inn',           -4840.7,  -857.1, 502.0),
    ('darnassus_bank',     1657, 1,   'bank',          'Darnassus Bank',           9942.0,  2519.2, 1317.7),
    ('darnassus_mailbox',  1657, 1,   'mailbox',       'Darnassus Mailbox',        9943.0,  2497.7, 1317.7),
    ('darnassus_ah',       1657, 1,   'auction_house', 'Darnassus Auction House',  9868.2,  2350.1, 1332.0),
    ('darnassus_inn',      1657, 1,   'inn',           'Darnassus Inn',           10127.9,  2224.8, 1328.8),
    ('exodar_bank',        3557, 530, 'bank',          'Exodar Bank',             -3919.0, -11544.7, -150.0),
    ('exodar_mailbox',     3557, 530, 'mailbox',       'Exodar Mailbox',          -3913.1, -11606.0, -138.4),
    ('exodar_ah',          3557, 530, 'auction_house', 'Exodar Auction House',    -4023.3, -11739.7, -151.8),
    ('exodar_inn',         3557, 530, 'inn',           'Exodar Inn',              -3746.4, -11696.1, -105.8),
