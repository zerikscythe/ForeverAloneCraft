...
VALUES
    ('stormwind_bank_01',           1519, 0, 'bank',                    'Stormwind Bank Counter 01',               -8939.28,   620.538,   99.606),
    ('stormwind_bank_02',           1519, 0, 'bank',                    'Stormwind Bank Counter 02',               -8931.23,   605.801,   99.606),
    ('stormwind_ah_01',             1519, 0, 'auction_house',           'Stormwind Auction House Desk 01',         -8824.28,   665.711,   97.4674),
    ('stormwind_ah_02',             1519, 0, 'auction_house',           'Stormwind Auction House Desk 02',         -8814.55,   660.315,   96.6818),
    ('stormwind_mailbox_01',        1519, 0, 'mailbox',                 'Stormwind Mailbox 01',                    -8876.98,   652.007,   95.9927),
    ('stormwind_mailbox_02',        1519, 0, 'mailbox',                 'Stormwind Mailbox 02',                    -8815.17,   652.927,   94.8966),
    ('stormwind_anvil_01',          1519, 0, 'anvil',                   'Stormwind Forge and Anvil',               -8433.50,   610.800,   95.7000),
    ('stormwind_kitchen_01',        1519, 0, 'kitchen',                 'Stormwind Kitchen',                       -8861.20,   670.900,   97.9000),
    ('stormwind_prof_alchemy_01',   1519, 0, 'profession_alchemy',      'Stormwind Alchemy Corner',                -8988.50,   759.400,  105.2000),
    ('stormwind_prof_lw_01',        1519, 0, 'profession_leatherworking','Stormwind Leatherworking Corner',        -8718.00,   465.600,  103.4000),
    ('stormwind_poi_old_town_01',   1519, 0, 'poi',                     'Stormwind Old Town Walk',                 -8664.00,   491.000,  103.0000),
    ('stormwind_poi_cathedral_01',  1519, 0, 'poi',                     'Stormwind Cathedral Square',              -8578.00,   812.000,  106.5000),
    ('stormwind_poi_mage_quarter_01',1519,0,'poi',                      'Stormwind Mage Quarter',                  -9003.50,   860.550,  105.8770),
...
INSERT INTO living_world_task_template
    (template_key, display_name, task_family, required_faction,
     ...
     weight, is_enabled)
VALUES
    ('stormwind_use_ah_01',            'Use AH 01 in Stormwind',               'city_errand', 1, 1, 80, 0, 0, 0, 2, 1),
    ('stormwind_use_ah_02',            'Use AH 02 in Stormwind',               'city_errand', 1, 1, 80, 0, 0, 0, 2, 1),
    ('stormwind_use_bank_01',          'Use Bank 01 in Stormwind',             'city_errand', 1, 1, 80, 0, 0, 0, 2, 1),
    ('stormwind_use_bank_02',          'Use Bank 02 in Stormwind',             'city_errand', 1, 1, 80, 0, 0, 0, 2, 1),
    ('stormwind_use_mailbox_01',       'Use Mailbox 01 in Stormwind',          'city_errand', 1, 1, 80, 0, 0, 0, 2, 1),
    ('stormwind_use_mailbox_02',       'Use Mailbox 02 in Stormwind',          'city_errand', 1, 1, 80, 0, 0, 0, 2, 1),
    ('stormwind_use_anvil_01',         'Use Anvil in Stormwind',               'city_errand', 1, 1, 80, 0, 0, 0, 1, 1),
    ('stormwind_use_kitchen_01',       'Use Kitchen in Stormwind',             'city_errand', 1, 1, 80, 0, 0, 0, 1, 1),
    ('stormwind_visit_prof_alch_01',   'Visit Alchemy in Stormwind',           'city_errand', 1, 1, 80, 0, 0, 0, 1, 1),
    ('stormwind_visit_prof_lw_01',     'Visit Leatherworking in Stormwind',    'city_errand', 1, 1, 80, 0, 0, 0, 1, 1),
    ('stormwind_visit_poi_old_town_01','Visit Old Town in Stormwind',          'city_errand', 1, 1, 80, 0, 0, 0, 1, 1),
    ('stormwind_idle_poi_cathedral_01','Idle by Cathedral in Stormwind',       'city_errand', 1, 1, 80, 0, 0, 0, 1, 1),
    ('stormwind_visit_poi_mage_01',    'Visit Mage Quarter in Stormwind',      'city_errand', 1, 1, 80, 0, 0, 0, 1, 1),
...
WHERE t.template_key IN (
    'stormwind_use_ah_01', 'stormwind_use_ah_02', 'stormwind_use_bank_01', 'stormwind_use_bank_02',
    'stormwind_use_mailbox_01', 'stormwind_use_mailbox_02', 'stormwind_use_anvil_01', 'stormwind_use_kitchen_01',
    'stormwind_visit_prof_alch_01', 'stormwind_visit_prof_lw_01', 'stormwind_visit_poi_old_town_01',
    'stormwind_idle_poi_cathedral_01', 'stormwind_visit_poi_mage_01',
...
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_ah_01', 45, 120, 'Browse the first auction lane'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_use_ah_01'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_ah_02', 45, 120, 'Browse the second auction lane'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_use_ah_02'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_bank_01', 40, 120, 'Check the first bank counter'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_use_bank_01'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_bank_02', 40, 120, 'Check the second bank counter'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_use_bank_02'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_mailbox_01', 20, 75, 'Sort mail at the main mailbox'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_use_mailbox_01'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_mailbox_02', 20, 75, 'Sort mail at the trade mailbox'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_use_mailbox_02'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_anvil_01', 60, 180, 'Hammer away at the forge'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_use_anvil_01'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_kitchen_01', 45, 150, 'Linger in the kitchen'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_use_kitchen_01'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_prof_alchemy_01', 60, 180, 'Visit the alchemy corner'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_visit_prof_alch_01'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_prof_lw_01', 60, 180, 'Visit the leatherworking corner'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_visit_prof_lw_01'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_poi_old_town_01', 75, 210, 'Wander through Old Town'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_visit_poi_old_town_01'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_poi_cathedral_01', 90, 240, 'Idle by Cathedral Square'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_idle_poi_cathedral_01'
UNION ALL
SELECT t.template_id, 1, 'idle_city', 1519, 'stormwind_poi_mage_quarter_01', 75, 210, 'Visit the Mage Quarter'
FROM living_world_task_template t WHERE t.template_key = 'stormwind_visit_poi_mage_01'
...
JOIN living_world_task_template t ON t.template_key = 'stormwind_use_mailbox_01'
WHERE p.playlist_key = 'stormwind_trade_shuffle'
UNION ALL
SELECT p.playlist_id, 2, t.template_id, 1, 'Work the first auction lane'
FROM living_world_playlist p
JOIN living_world_task_template t ON t.template_key = 'stormwind_use_ah_01'
WHERE p.playlist_key = 'stormwind_trade_shuffle'
UNION ALL
SELECT p.playlist_id, 3, t.template_id, 1, 'Visit the bank'
FROM living_world_playlist p
JOIN living_world_task_template t ON t.template_key = 'stormwind_use_bank_02'
WHERE p.playlist_key = 'stormwind_trade_shuffle'
UNION ALL
SELECT p.playlist_id, 4, t.template_id, 1, 'Loop back through a second mailbox'
FROM living_world_playlist p
JOIN living_world_task_template t ON t.template_key = 'stormwind_use_mailbox_02'
WHERE p.playlist_key = 'stormwind_trade_shuffle'

UNION ALL
SELECT p.playlist_id, 1, t.template_id, 1, 'Start at the forge'
FROM living_world_playlist p
JOIN living_world_task_template t ON t.template_key = 'stormwind_use_anvil_01'
WHERE p.playlist_key = 'stormwind_crafter_afternoon'
UNION ALL
SELECT p.playlist_id, 2, t.template_id, 1, 'Check alchemy supplies'
FROM living_world_playlist p
JOIN living_world_task_template t ON t.template_key = 'stormwind_visit_prof_alch_01'
WHERE p.playlist_key = 'stormwind_crafter_afternoon'
UNION ALL
SELECT p.playlist_id, 3, t.template_id, 1, 'Stop in the kitchen'
FROM living_world_playlist p
JOIN living_world_task_template t ON t.template_key = 'stormwind_use_kitchen_01'
WHERE p.playlist_key = 'stormwind_crafter_afternoon'
UNION ALL
SELECT p.playlist_id, 4, t.template_id, 1, 'End with leatherworking'
FROM living_world_playlist p
JOIN living_world_task_template t ON t.template_key = 'stormwind_visit_prof_lw_01'
WHERE p.playlist_key = 'stormwind_crafter_afternoon'

UNION ALL
SELECT p.playlist_id, 1, t.template_id, 1, 'Visit the Mage Quarter'
FROM living_world_playlist p
JOIN living_world_task_template t ON t.template_key = 'stormwind_visit_poi_mage_01'
WHERE p.playlist_key = 'stormwind_district_wander'
UNION ALL
SELECT p.playlist_id, 2, t.template_id, 1, 'Cross into Cathedral Square'
FROM living_world_playlist p
JOIN living_world_task_template t ON t.template_key = 'stormwind_idle_poi_cathedral_01'
WHERE p.playlist_key = 'stormwind_district_wander'
UNION ALL
SELECT p.playlist_id, 3, t.template_id, 1, 'Drift through Old Town'
FROM living_world_playlist p
JOIN living_world_task_template t ON t.template_key = 'stormwind_visit_poi_old_town_01'
WHERE p.playlist_key = 'stormwind_district_wander'
