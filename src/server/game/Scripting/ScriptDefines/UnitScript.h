...
enum UnitHook
{
    ...
    UNITHOOK_ON_CALCULATE_EFFECTIVE_RESISTANCE,
...
public:
    ...
    virtual void OnCalculateEffectiveResistance(Unit const* /*owner*/, SpellSchoolMask /*schoolMask*/, Unit const* /*victim*/, SpellInfo const* /*spellInfo*/, float& /*victimResistance*/) { }
