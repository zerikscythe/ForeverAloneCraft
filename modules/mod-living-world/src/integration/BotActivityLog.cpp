    ...
    std::string_view detail)
{
    ...
    CharacterDatabase.Execute("INSERT INTO living_world_bot_activity_log (bot_guid, bot_name, event_type, detail, map_id, zone_id, pos_x, pos_y, pos_z) VALUES ({}, '{}', '{}', '{}', {}, {}, {}, {}, {})", guid, name, eventType, detail, mapId, zoneId, x, y, z);
}
...
void BotActivityLog::Record(Unit* bot, std::string_view botName, std::uint64_t botIdentityId, std::string_view eventType, std::string_view detail)
{
    ...
    CharacterDatabase.Execute("INSERT INTO living_world_bot_activity_log (bot_guid, bot_name, event_type, detail, map_id, zone_id, pos_x, pos_y, pos_z) VALUES ({}, '{}', '{}', '{}', {}, {}, {}, {}, {})", botIdentityId, botName, eventType, detail, mapId, zoneId, x, y, z);
}
